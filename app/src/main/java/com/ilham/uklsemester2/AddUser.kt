...
import com.ilham.uklsemester2.databinding.ActivityAddUserBinding
...
class AddUser : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val spinner = binding.addUserSpJobs
        ...
        binding.addUserBtnSave.setOnClickListener{
            ...
            val password = binding.addUserEtPass.text.toString()
            ...
            when{
                ...
                password.isEmpty() -> alert()
                    ...
                    userViewModel.insertUser(User(name = name, jobdesk = jobdesc, username = userName , password = password, image = 0))
                    startActivity(Intent(this, DataUser::class.java))
                    finish()
                }
            }
