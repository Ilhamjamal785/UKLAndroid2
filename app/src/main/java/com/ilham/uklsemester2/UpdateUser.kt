...
import com.ilham.uklsemester2.databinding.ActivityUpdateUserBinding
        ...
        binding.updateUserBtnSave.setOnClickListener {
            ...
            when{
                ...
                job == "pilih" -> alert()
                    ...
                    val updatedUser = User(name = newName, jobdesk = job.toString(), username = newUserName , password = newPassword, image = 0)
                    updatedUser.id = id
