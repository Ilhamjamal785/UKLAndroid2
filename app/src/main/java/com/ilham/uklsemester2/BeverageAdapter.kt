...
import com.ilham.uklsemester2.databinding.RvCardMinumanBinding

class BeverageAdapter(private val context: Context, private val beverages : ArrayList<Beverage>,
                      private val beverageViewModel: MenuViewModel): RecyclerView.Adapter<BeverageAdapter.ViewHolder>() {
    inner class ViewHolder(private val binding : RvCardMinumanBinding): RecyclerView.ViewHolder(binding.root) {
        fun bind(beverage: Beverage){
            ...
            when(beverage.image){
                1 -> binding.cardMinumanIvImage.setImageResource(R.drawable.arakbali)

                2 -> binding.cardMinumanIvImage.setImageResource(R.drawable.cincau)

                3 -> binding.cardMinumanIvImage.setImageResource(R.drawable.cendol)
